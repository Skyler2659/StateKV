#!/usr/bin/env python
"""Analyze final-boundary pullback and apply its frozen gates."""
...
from statekv.candidate_pullback_analysis import (
    analyze_candidate_pullback,
)
...
def main() -> None:
    ...
    print(analyze_candidate_pullback(cfg, run_dir))
