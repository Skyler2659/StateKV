...
in `analysis/tables/`, and the closure documents in `analysis/*.md`. The claims
...
| 33 | qk_obswin(w32) | SnapKV-style observation-window full-pool score at h16, budget 64 | KL 1.0748 vs qk_pool@h16 0.8439; NIAH 0.0 both; paired 2/10 — NO_GO_CORNER (backward-looking window is stale-biased) | none; corner recorded as boundary condition (fix is cadence, not scoring) | 10 samples, E2 recoverable | preregistered corner gate | analysis/statekv_corner_gate.md; results/temporal_cache_discovery/statekv_corner_obswin_768_64_h16_v1/sample_results.csv |
...
6. **Completeness sources.** Entries were cross-checked against
   ...
   (`analysis/statekv_external_validity_report.md`) is a DRAFT with all
